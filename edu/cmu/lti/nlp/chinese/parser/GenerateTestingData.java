...
public class GenerateTestingData{
  //private static Logger log = Logger.getLogger( GenerateTestingData.class );
  ...
  public static void main(String[] args){
    if(args.length != 2){
      System.err.println("Usage: java GenerateTestingData LANG(E|C) dir_name");
      System.exit(1);
    }
    try{
      if(args[0].equals("E"))
      ...
      try{
        String fileName = dir.getPath()+"/all.testing";
