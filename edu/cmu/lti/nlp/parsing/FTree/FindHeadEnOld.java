...
public class FindHeadEnOld extends FindHead{
	//singlten pattern with lazy loading
	private static  FindHeadEnOld instance =null;
	public static FindHeadEnOld getInstance() {
		if (instance==null) 	 instance = new FindHeadEnOld();			
		return instance;
	}
	...
	public void initHeadRules(){
	    ...
	    m_head_rules.put("SQ", new String[][]{{"left", "VBZ", "VBD", "VBP", "VB", "MD", "VP", "SQ"}});
